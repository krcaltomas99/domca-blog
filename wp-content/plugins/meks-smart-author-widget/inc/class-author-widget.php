...
class MKS_Author_Widget extends WP_Widget
{
		...
		var $defaults; //Do not run get_users() if there are more than 200 users on the website
private $users_split_at = 200;
	...
	function form($instance)
	{
		...
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'meks-smart-author-widget'); ?>
				:</label>
		...
		<p>
			...
			<?php if ($this->count_users() <= $this->users_split_at) : ?>
				...
				<label for="<?php echo $this->get_field_id('author'); ?>"><?php _e('Choose author/user', 'meks-smart-author-widget'); ?>
					:</label>
			...
			<?php else: ?>
				...
				<label for="<?php echo $this->get_field_id('author'); ?>"><?php _e('Enter author/user ID', 'meks-smart-author-widget'); ?>
					:</label>
				<input id="<?php echo $this->get_field_id('author'); ?>" type="text"
				       name="<?php echo $this->get_field_name('author'); ?>" value="<?php echo $instance['author']; ?>"
				       class="small-text"/>
		...
		<p>
			<input id="<?php echo $this->get_field_id('auto_detect'); ?>" type="checkbox"
			       name="<?php echo $this->get_field_name('auto_detect'); ?>"
			       value="1" <?php checked(1, $instance['auto_detect']); ?>/>
		...
		<ul>
			<li>
				<input id="<?php echo $this->get_field_id('display_avatar'); ?>" type="checkbox"
				       ...
				       value="1" <?php checked(1, $instance['display_avatar']); ?>/>
			...
			<li>
				...
				<input id="<?php echo $this->get_field_id('avatar_size'); ?>" type="text"
				       name="<?php echo $this->get_field_name('avatar_size'); ?>"
				       value="<?php echo $instance['avatar_size']; ?>" class="small-text"/> px
			</li>
		</ul>
		<hr/>
		<ul>
			<li>
				<input id="<?php echo $this->get_field_id('display_name'); ?>" type="checkbox"
				       name="<?php echo $this->get_field_name('display_name'); ?>"
				       value="1" <?php checked(1, $instance['display_name']); ?>/>
				<label for="<?php echo $this->get_field_id('display_name'); ?>"><?php _e('Display author name', 'meks-smart-author-widget'); ?></label>
			</li>
			<li>
				<input id="<?php echo $this->get_field_id('name_to_title'); ?>" type="checkbox"
				       name="<?php echo $this->get_field_name('name_to_title'); ?>"
				       value="1" <?php checked(1, $instance['name_to_title']); ?>/>
		...
		<ul>
			<li>
				<input id="<?php echo $this->get_field_id('display_desc'); ?>" type="checkbox"
				       ...
				       value="1" <?php checked(1, $instance['display_desc']); ?>/>
			...
			<li>
				...
				<input id="<?php echo $this->get_field_id('limit_chars'); ?>" type="number"
				       ...
				       value="<?php echo $instance['limit_chars']; ?>" class="widefat"/>
		...
		<ul>
			<li>
				<input id="<?php echo $this->get_field_id('link_to_name'); ?>" type="checkbox"
				       name="<?php echo $this->get_field_name('link_to_name'); ?>"
				       value="1" <?php checked(1, $instance['link_to_name']); ?>/>
				<label for="<?php echo $this->get_field_id('link_to_name'); ?>"><?php _e('Link author name', 'meks-smart-author-widget'); ?></label>
			</li>
			<li>
				<input id="<?php echo $this->get_field_id('link_to_avatar'); ?>" type="checkbox"
				       name="<?php echo $this->get_field_name('link_to_avatar'); ?>"
				       value="1" <?php checked(1, $instance['link_to_avatar']); ?>/>
			...
			<li>
				<input id="<?php echo $this->get_field_id('display_all_posts'); ?>" type="checkbox"
				       ...
				       value="1" <?php checked(1, $instance['display_all_posts']); ?>/>
			...
			<li>
				...
				<input id="<?php echo $this->get_field_id('link_text'); ?>" type="text"
				       ...
				       value="<?php echo $instance['link_text']; ?>" class="widefat"/>
			...
			<li>
				...
				<input id="<?php echo $this->get_field_id('link_url'); ?>" type="text"
